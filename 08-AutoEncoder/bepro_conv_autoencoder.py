...
#            nn.MaxPool2d(2, stride=(2,2)),  # b, 8, 8, 8
        ...
        self.decoder = nn.Sequential(
            nn.ConvTranspose2d(4, 16, (3,3), stride=(2,2), padding=(2,2)),  # b, 16, 16, 16
            nn.ReLU(True),
            nn.ConvTranspose2d(16, 32, (3,3), stride=(2,2), padding=(2,2)),  # b, 32, 32, 32
            nn.ReLU(True),
            nn.ConvTranspose2d(32, 64, (3,3), stride=(2,2), padding=(2,2)),  # b, 64, 64, 64
            nn.ReLU(True),
